...
Der 4G-Standard verspricht, gegenüber dem 3G-Standard, eine deutlich schnellere Übertragungsrate von bis zu 100MBit/s und in manchen Situationen auch von bis zu 1GBit/s. %https://en.wikipedia.org/wiki/4G
...
Diese Verbesserung wurde von dem 3GPP (3rd Generation Partnership Project) eingebracht, das auch zu der Entwicklung des 5G-Standards maßgeblich beigetragen hat. %https://en.wikipedia.org/wiki/3GPP


\section{5G-Standard}
Der 5G-Standard ist die fünfte Generation der Breitband-Mobilfunknetz-Technologie. %https://en.wikipedia.org/wiki/5G
Er ist der Nachfolger des 4G-Standards und der bisher neueste Standard auf dem Markt.
Er wurde von dem 3GPP definiert und soll gegen Ende 2019 von mindestens 10\% aller Mobilfunktelefone unterstützt werden. %https://en.wikipedia.org/wiki/5G
...
Des Weiteren wird auf die Sicherheit des Protokolls eingegangen, indem eine Sicherheitslücke dieses Protokolls beschrieben und implementiert wird. %https://www.cs.ox.ac.uk/5G-analysis/5G-AKA-draft-vulnerability.pdf
